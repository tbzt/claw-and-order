...
export const pnj = {
  ...
  mark: {
    ...
    taille: 1.86,
    motsCles: [
      'Humain, dix-neuf ans — grand dadais, gauche',
      'Renton, enfant d’artistes, graphiste en piges',
      'Amoureux d’elle, et elle le savait — elle a refusé avec tendresse',
      'Train de vie : ce que rapportent les piges',
  ...
  psych: {
    ...
    taille: 1.90,
    motsCles: [
      'Elfe androgyne, âge indéterminé',
      'Cyberyeux bleus, mohawk de la même couleur',
      'Sur une piste de danse ou à un concert, le reste du temps nulle part',
      'Train de vie : ce qu’on lui donne',
      'Était dans la fosse le soir où elle est montée',
    ],
    comportements: [
    ...
    repliques: [
      '« T’as quelque chose ? »',
      '« Dix secondes. Elle est restée dix secondes là-haut. »',
      '« Waters a tout gardé. Waters garde tout. »',
      '« Personne me demande jamais de quoi elle avait l’air. »',
    ],
  ...
  nova: {
    ...
    taille: 1.52,
    motsCles: [
      'Melissa Patterson, la vingtaine — haute comme trois pommes',
      'Bellevue, parents cadres haut placés chez Microdeck',
      'Novarich depuis un an, et la phase commence à prendre',
      'Similicuir blanc à éclairs jaunes, lunettes chrome, chewing-gum',
      'Interrogée avant vous, et elle n’en parle pas',
    ],
    comportements: [
      'Se place entre vous et l’escalier sans qu’on le lui ait demandé.',
      'Ne dit jamais la première chose qu’on lui demande.',
      'Fait des bulles en vous dévisageant, et laisse le silence durer.',
    ...
    repliques: [
      ...
      '« Elle est montée, et nous on tenait le bas. »',
    ],
  ...
  nita: {
    ...
    taille: 1.20,
    motsCles: [
      'Naine à la peau cuivrée, chamane de l’Ours',
      'Du Conseil algonkin-manitou, permanence de l’ORC à Loveland',
