...
export const appels = {
  ...
  'elton|dossier-vide': {
    ...
    ligne: [
      ...
      '« Personne ne monte un dossier aussi mince pour gagner un procès. On le monte pour ne pas en avoir. »',
    ],
  ...
  'elton|registre-anterieur': {
    ...
    ligne: [
      ...
      '« Un registre horodaté avant l’arrestation elle-même ? Ça, Pitchford, ça ne se plaide pas comme une négligence administrative. Ça se plaide comme une préméditation. Quelqu’un a écrit l’issue avant d’écrire l’accusation. »',
    ...
    reaction: '« Il appelle ça une préméditation. Moi j’appelle ça un plan B qui traîne depuis le début. »',
  },
  ...
  'elton|teresa': {
    ...
    ligne: [
      ...
      '« Une qualification, ça se choisit. Celle-là a été choisie pour que personne n’ait à chercher plus loin. »',
    ],
  ...
  'herwick|teresa': {
    ...
    ligne: [
      ...
      '« Ah. Toi. Teresa Banks, tu dis ? Le bruit qui court sur mon trottoir, c’est qu’on l’a retrouvée dans un taudis de Loveland — pas dans une ruelle, dans un TAUDIS, un vrai, avec une adresse et un propriétaire qui ne demande rien à personne. Ce genre d’endroit ne s’improvise pas comme scène de crime. On le choisit. »',
    ...
    reaction: '« Un antiquaire qui connaît la carte des taudis mieux que la police. Ça devrait m’inquiéter plus que ça ne le fait. »',
  },
  'herwick|dossier-vide': {
    ...
    ligne: [
      '« Strauber. »',
      '« Un dossier vide, chez la Lone Star ? Rien d’étonnant : son appartement n’y figure même pas. Pas une adresse, pas un bail, rien. Officiellement, cette fille n’avait pas de chez-elle. Officieusement, j’en connais l’adresse depuis plus longtemps qu’eux. »',
      '« Ce qu’on ne verse pas à un dossier, compagnon, c’est en général ce qu’on ne veut pas qu’on visite. »',
    ],
    dejaLigne: '« Son appartement n’est toujours pas dans leurs papiers. Toujours dans les miens. »',
    reaction: '« Ce que la police archive et ce que la rue retient ne sont jamais la même liste. Bon à savoir. »',
  },
  'herwick|grand-blond': {
    id: 'travail-inacheve',
    minutes: 15,
    ligne: [
      '« Strauber, j’écoute. »',
      '« Un grand blond, monté sur un bateau et reparti à pied par le talus ? Ça sent le professionnel qui n’a pas eu le temps de finir proprement — des fils arrachés à la va-vite, ce n’est pas du travail, compagnon, c’est une fuite. Quelqu’un l’a dérangé avant qu’il boucle son affaire. »',
      '« Un pro qui s’enfuit sans finir, c’est un pro qui reviendra. Ou qui enverra quelqu’un d’autre. »',
    ],
  ...
  'herwick|appart-hors-dossier': {
    ...
    ligne: [
      ...
      '« La géographie ne ment jamais. Ce sont les rapports de police qui mentent, sur la géographie. »',
    ],
  ...
  'duke|toralf-vise-lester': {
    ...
    reaction: '« Rabbit connaît son monde. S’il dit Chimera, c’est Chimera. »',
  },
  'duke|chimera-nous-suit': {
    ...
    ligne: [
      ...
      '« Personne n’improvise un sniper la nuit même. On le réserve d’avance, comme une table au restaurant. »',
    ],
  ...
  'duke|grand-blond': {
    ...
    ligne: [
      '« Ouais ? »',
      '« Un grand blond qui plante proprement, deux coups, pas un de plus ? C’est pas le même tarif qu’un étranglement, crois-moi. Ceux qui étranglent, c’est de la colère ou de l’impro. Ceux qui plantent à deux coups nets, c’est un professionnel qui facture à la prestation. Deux styles, deux factures, deux mecs. »',
