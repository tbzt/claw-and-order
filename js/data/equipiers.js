...
const SOI = {
  hercules:
    "« Un mètre vingt de charme et une ardoise. Les deux tiennent debout tant que je parle. »",
  trash:
    "« Une écharpe rayée, des bottes trouées, et un nom de famille que je ne prononce plus. »",
  rabbit:
    "« Deux cent mille nuyens de chirurgie. Personne n’a jamais demandé pourquoi, et c’est la preuve que ça marche. »",
...
const REGARDS = {
  hercules: {
    trash:
      "« Il tient sa mise comme si elle était plus grosse. Ça marche presque toujours, et je le lui envie. »",
    rabbit:
      "« Train de vie bas, montre chère. Il a eu de l’argent, il n’en a plus, il n’en parle pas. »",
    drakk:
      "« Un halfelin beau parleur. Toute compagnie en a un, et sans lui la compagnie se fait tuer au premier village. »",
  },

  trash: {
    hercules:
      "« Grand, mince, et parfaitement inutile en cas de bagarre. Il le sait. C’est pour ça qu’il n’y en a jamais avec lui. »",
    rabbit:
      "« Son aura est propre. Trop propre pour quelqu’un qui dort dehors — il a choisi de dormir dehors. Ce n’est pas pareil. »",
    drakk:
      "« Un elfe. Noble, si je lis ses manières. Il rend le sel à table avec les deux mains. »",
  },

  rabbit: {
    hercules:
      "« Il a payé pour ces défenses. Je ne juge pas : moi j’ai payé pour un costume. La différence est qu’on peut retirer un costume. »",
    trash:
      "« Il porte un visage qui n’est pas celui de sa naissance, et il le porte bien. L’aura, elle, n’a pas suivi. Elle est restée humaine. »",
    drakk:
      "« Un ork qui n’a pas la démarche d’un ork. La statistique ne ment pas, la fiche de personnage non plus. »",
  },

  drakk: {
    hercules:
      "« Deux mètres cinquante de raisons de ne pas négocier. J’adore travailler avec lui, ça raccourcit mes phrases. »",
    trash:
      "« Il y a de la place pour trois esprits dans cet homme et il n’y en a aucun. Il est seul là-dedans, et il tient quand même. »",
    rabbit:
      "« Il lit un livre en papier. En 2081. Il l’a lu deux cents fois et il en parle comme d’une première fois. »",
  },
};
...
const ECHANGES = {
  hercules: {
    trash: [
      [
        "trash",
        "« Hercules. Si Raton laveur te demandait quelque chose, tu dirais oui ? »",
      ],
    ...
    rabbit: [
      ...
      [
        "hercules",
        "« J’ai besoin de quarante secondes de silence pendant que je parle. »",
      ],
  ...
  trash: {
    hercules: [
      ...
      [
        "hercules",
        "« C’est pour ça que je la pose. Les gens répondent quand ils sont vexés. »",
      ],
  ...
  rabbit: {
    hercules: [
      ...
      [
        "hercules",
        "« Voilà. Ça. Ne finis jamais cette phrase et tout ira bien. »",
      ],
    ],
    trash: [
      ...
      [
        "trash",
        "« Non. Je te dis juste qu’elle est belle telle qu’elle est. »",
      ],
...
const TABLEAUX = {
  bar: {
    ...
    hercules: {
      vu: [
        "Un nain d’une cinquantaine d’années en costume correct et fatigué. Il tient les apparences ; il n’a plus les moyens.",
  ...
  herwick: {
    drakk: {
      ...
      hercules:
        "« Il n’a pas quitté ce rideau des yeux depuis qu’on est entrés. Ce n’est pas de la méfiance. C’est de la culpabilité qui a pris la forme d’une vigilance. »",
    },
    hercules: {
      vu: "Il évalue le stock du regard, par réflexe, et s’arrête net en réalisant ce qu’il est en train de faire.",
      trash:
        "« Il vient de chiffrer toute la boutique en une seconde, et il vient de s’en vouloir tout aussi vite. »",
    },
  },
  ...
  sarah: {
    trash: {
      ...
      hercules:
        "« Il connaît cette pièce mieux qu’il ne connaît la nôtre. Ça devrait m’inquiéter pour lui, et ça ne fait que me rassurer pour nous. »",
    },
    hercules: {
  ...
  squat: {
    trash: {
      ...
      drakk:
        "« Il garde un œil sur chaque chose qu’il a sauvée, l’un après l’autre. C’est la première fois de la nuit que je le vois monter la garde sur autre chose qu’une personne. »",
    },
    drakk: {
  ...
  shameless: {
    ...
    rabbit: {
      ...
      trash:
        "« Son aura s’est refermée d’un cran en entrant. Ce n’est pas la musique. C’est le genre de silence que les riches paient pour avoir. »",
    },
  },
  ...
  waters: {
    ...
    hercules: {
      ...
      trash:
        "« Il vient de reconnaître un homme qui a raté quelque chose, parce qu’il en est un lui aussi. Ça ne le rend pas plus tendre. Ça le rend plus précis. »",
    },
  },
};
